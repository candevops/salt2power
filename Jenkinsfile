...
//                 powershell returnStatus: true, script: """C:\\MyData\\Workspace_cloud_devops\\1-salt-to-powershell\\analytic_engine.ps1 1.2.0-beta G:\\App\\Aurora aurora analytic-engine 6.5.0-beta.24 sxs zip"""
              powershell  returnStatus: true, script: """C:\\MyData\\Workspace_cloud_devops\\1-salt-to-powershell\\analytic_engine.ps1 1.2.0-beta C:\\App\\Aurora aurora analytic-engine 6.5.0-beta.24 sxs zip MCClientFlagFilesPath=.\\C_MCClientConfig64_20210916.A.DEV%3BMOB_PARAM:mdsx_mode=PRODPL"""
  //              powershell  returnStatus: true, script: "\$ExecutionPolicy='Bypass'; \$ErrorActionPreference='Stop';\$ProgressPreference= 'SilentlyContinue';'C:\\MyData\\Workspace_cloud_devops\\1-salt-to-powershell\\analytic_engine.ps1 1.2.0-beta C:\\App\\Aurora aurora analytic-engine 6.5.0-beta.24 sxs zip MCClientFlagFilesPath=.\\C_MCClientConfig64_20210916.A.DEV%3BMOB_PARAM:mdsx_mode=PRODPL'"
