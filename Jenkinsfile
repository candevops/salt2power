        ...
        stage('build') {
            steps {
             echo 'We are Starting the Testing'
                ...
                //$args5 = "sxs"
                //$args6 = "zip"                
         """ Powershell.exe -Executionpolicy bypass -ErrorActionPreference Stop -ProgressPreference SilentlyContinue -File  ".\\scripts\\install_analytic_engine.ps1" $credit_version $artifact_install $artifact_zip $environment_variables 
"""
