        ...
        stage('build') {
            steps {
             echo 'We are Starting the Testing'
                ...
                //$args5 = "sxs"
                //$args6 = "zip"
                powershell script: "\$ErrorActionPreference='Stop';'C:\\MyData\\Workspace_cloud_devops\\1-salt-to-powershell\\analytic_engine.ps1 1.2.0-beta G:\\App\\Aurora aurora analytic-engine 6.5.0-beta.24 sxs zip'"
